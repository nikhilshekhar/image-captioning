from core.imageCaptioning.model import *
...
caption_generator = CaptionGenerator(dim_image=dim_image, dim_hidden=dim_hidden, dim_embed=dim_embed,
                                     batch_size=batch_size, n_lstm_steps=maxlen, n_words=n_words)
